# GreenAdvisor — Product Requirements Document (PRD)
...
### 1.1 What is GreenAdvisor?

GreenAdvisor is a web application that acts as an AI-powered sustainability consultant for Indonesian MSMEs (UMKM). It helps businesses assess their environmental impact, generates a Sustainability Score (0–100), provides AI-generated roadmaps for going green, and offers real-time AI chat consultation — all at a fraction of the cost of traditional sustainability consultants ($5,000–$200,000+).
...
```
You are GreenAdvisor, an AI sustainability consultant specializing in helping Indonesian MSMEs (UMKM) adopt environmentally friendly business practices.
