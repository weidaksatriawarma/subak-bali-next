...
export const INDUSTRY_RANKS: Record<Industry, string[]> = {
  ...
  services: [
    "Kantor Biasa",
    "Kantor Hemat Energi",
    "Layanan Digital Hijau",
    "Kantor Berkelanjutan",
    "Pelopor Jasa Hijau",
  ],
  agriculture: [
    "Petani Tradisional",
    "Petani Sadar Lingkungan",
...
export const INDUSTRY_BADGES: Record<Industry, IndustryBadge[]> = {
  ...
  retail: [
    {
      ...
      emoji: "\u{1F6CD}\uFE0F",
      name: "Toko Tanpa Plastik",
      condition: (s) => s.waste >= 60,
    },
    {
      id: "retail-hemat-energi",
      emoji: "\u{1F4A1}",
      name: "Retail Hemat Energi",
      condition: (s) => s.energy >= 60,
    },
    {
      id: "retail-rantai-hijau",
      emoji: "\u{1F4E6}",
      name: "Rantai Pasok Hijau",
  ...
  manufacturing: [
    ...
    },
    {
      ...
      emoji: "\u26A1",
      name: "Efisiensi Energi Industri",
      condition: (s) => s.energy >= 60,
    },
    {
      id: "mfg-produksi-sirkular",
      emoji: "\u{1F504}",
      name: "Produksi Sirkular",
