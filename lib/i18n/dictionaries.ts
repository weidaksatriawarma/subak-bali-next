...
const id: Dictionary = {
  ...
  socialProof: {
    ...
    subheading:
      "Lihat bagaimana GreenAdvisor membantu pelaku usaha menjadi lebih berkelanjutan",
    items: [
      {
        type: "Warung",
        quote:
  ...
  dashboard: {
    ...
    score: {
      ...
      report: {
        ...
        impact: "Dampak",
        footer:
          "Generated by GreenAdvisor, Konsultan AI Sustainability untuk UMKM Indonesia",
      },
    },
    roadmap: {
  ...
  dashboard: {
    ...
    score: {
      ...
      report: {
        ...
        impact: "Impact",
        footer:
          "Generated by GreenAdvisor, AI Sustainability Consultant for Indonesian MSMEs",
      },
    },
    roadmap: {
