    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "subakhijau-cookie-consent: Menyimpan pilihan persetujuan cookie Anda (accepted/declined). Jenis: local storage. Durasi: permanen hingga dihapus manual.",
      ...
      },
      {
        ...
        content: [
          "Saat pertama kali mengunjungi situs, Anda dapat memilih Terima atau Tolak cookie fungsional melalui banner persetujuan.",
          "Anda juga dapat mengubah preferensi cookie kapan saja melalui halaman Pengaturan di dashboard.",
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "subakhijau-cookie-consent: Stores your cookie consent choice (accepted/declined). Type: local storage. Duration: permanent until manually cleared.",
      ...
      },
      {
        ...
        content: [
          "When first visiting the site, you can choose to Accept or Decline functional cookies via the consent banner.",
          "You can also change your cookie preferences at any time through the Settings page in the dashboard.",
